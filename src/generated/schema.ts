...
export interface paths {
    ...
    "/webhooks/deliveries/": {
         ...
         * @description Returns a paginated list of webhook deliveries for a specific source object (Purchase, Payment, Payout, or BillingTemplateClient).
         *
         ...
         */
        get: operations["webhooks_deliveries_list"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        PaymentMethod: "citadele_ee_digilink" | "citadele_ee_pis" | "citadele_lt_digilink" | "citadele_lt_pis" | "citadele_lv_digilink" | "citadele_lv_pis" | "coop_pank_ee_pis" | "indexo_ee_pis" | "indexo_lt_pis" | "indexo_lv_pis" | "indexo_pis" | "klix" | "klix_apple_pay" | "klix_google_pay" | "klix_pay_later" | "klix_pay_later_ee" | "klix_pay_later_lt" | "klix_pay_later_lv" | "lhv_ee_pis" | "lku_lt_pis" | "luminor_ee_pis" | "luminor_lt_pis" | "luminor_lv_pis" | "paysera_ee_pis" | "paysera_lt_pis" | "paysera_lv_pis" | "revolut_pis" | "seb_ee_pis" | "seb_lt_pis" | "seb_lv_pis" | "siauliu_lt_pis" | "swedbank_ee_pis" | "swedbank_lt_pis" | "swedbank_lv_pis" | "unknown";
            ...
            readonly transaction_data?: {
                ...
                attempts?: {
                    ...
                    error?: {
                         ...
                         *     ---
                         *
                         *     `payment_expired`: Payment session or authorization has expired
                         */
                        code?: string;
        ...
        Product: {
            ...
            category?: string;
            /** @default null */
            total_price_override: components["schemas"]["MoneyAmount"] | null;
        };
        /**
        ...
        PurchaseDetails: {
            ...
            /**
             * Format: ISO 639-1
             * @description Language code in the ISO 639-1 format (e.g. 'en'). Supported values: `en`, `et`, `lt`, `lv`, `ru`.
            ...
            /** @description A list of shipping methods to be displayed on klix checkout form. */
            shipping_options?: {
                /** @description Shipping method id configured in the klix backoffice. Must match exactly. */
                id?: string;
                /** @description Price of shipping for this shipping method. Will be added to the order total. Amount of money as the smallest indivisible units of the currency. Examples: 1 cent for EUR and 1 Yen for JPY. */
                price?: number;
            }[];
            /** @description Custom information with maximum length of 10000 characters */
            metadata?: Record<string, never>;
            /**
             * @description When set to true, prevents retry attempts if the payment fails. The purchase will be immediately marked as cancelled upon failure, and the payer will not see a retry button on the failure page. If not provided, inherits the value from the Company's `single_attempt` setting.
             * @default false
             */
         ...
         * @enum {string}
         */
        TransactionFlow: "api" | "edd" | "fluentcart" | "fluentforms" | "formidableforms" | "givewp" | "gohighlevel" | "gravityforms" | "hostbill" | "import" | "link" | "magento" | "opencart" | "payform" | "paymattic" | "perfexcrm" | "pos" | "prestashop" | "shopify" | "web_office" | "whmcs" | "woocommerce" | "woocommerce_subscriptions" | "wpcharitable" | "wpfunnels";
        /**
         ...
         * @enum {string}
         */
        TransactionProduct: "atm_cash" | "atm_cash_reversal" | "bank_payment" | "cashback" | "cashback_reversal" | "chargeback" | "chargeback_reversal" | "custom_payment" | "deposit" | "deposit_reversal" | "invoice" | "manual_cash" | "manual_cash_reversal" | "purchase" | "refund" | "refund_reversal" | "subscription";
        /** Format: url */
        URL: string;
        /**
        ...
        /** @description Record of a webhook delivery attempt, including the event data sent, delivery status, and retry attempts. */
        WebhookDelivery: {
            /**
             * Format: date-time
             * @description Timestamp when the webhook delivery was created.
             * @example 2025-08-19T07:29:25.612314Z
             */
            created_on?: string;
            /**
             * Format: date-time
             * @description Timestamp when the webhook was successfully delivered. Null if not yet delivered or failed.
             * @example null
             */
            delivered_on?: string | null;
            /**
             * @description Number of delivery attempts made for this webhook.
             * @example 0
             */
            attempts?: number;
            /** @description List of delivery attempts made for this webhook, ordered by most recent first. */
            delivery_attempts?: components["schemas"]["WebhookDeliveryAttempt"][];
            /**
             * Format: url
             * @description The URL the webhook is being (or was) delivered to.
             * @example https://webhook.example.com/endpoint
             */
            url?: string;
            /** @description The event type that triggered this delivery. */
            event?: components["schemas"]["Event"];
            /**
             * @description The actual payload that was sent (or will be sent) to the webhook endpoint. Contains the full object data for the event.
             * @example {
             *       "title": "Test is_internal=False"
             *     }
             */
            payload?: Record<string, never> | null;
        };
        /** @description Record of an individual webhook delivery attempt. */
        WebhookDeliveryAttempt: {
            /**
             * Format: date-time
             * @description Timestamp when this delivery attempt was made.
             * @example 2025-08-19T07:30:15.123456Z
             */
            attempted_on?: string;
            /**
             * @description Error message if the delivery attempt failed, describing what went wrong.
             * @example Connection timeout after 30 seconds
             */
            error_message?: string;
        };
        /**
         * @description Type of object that can trigger webhook events.
         * @enum {string}
         */
        WebhookSourceType: "purchase" | "payment" | "payout" | "billing_template_client";
...
export interface operations {
    purchases_create: {
        ...
        requestBody: {
            content: {
                 ...
                 *               "creditor_iban": "LV55HABA1111111111111"
                 *             },
                 *             {
                 *               "creditor_name": "Jane Doe",
                 *               "creditor_iban": "LV55HABA1111111111112"
                 *             }
                 *           ],
                 *           "pis_purchase": {
                 *             "creditor": {
    ...
    purchases_refund: {
        ...
        requestBody?: {
            content: {
                /**
                 * @example {
                 *       "client_name": "Janis Kalnins",
                 *       "amount": 100
                 *     }
                 */
                "application/json": {
                    /** @description Name and surname of a client */
                    client_name: string;
                    /**
                ...
                content: {
                    "application/json": {
                        ...
                        payment_method_groups?: {
                            /** @description Name of the payment method group. */
                            name?: string;
                            /** @description Path to the logo file for the payment method group. */
                            logo?: string;
                            /** @description Display label for the payment method group. */
                            label?: string;
                            methods?: string[];
                        }[];
                    };
    ...
    webhooks_deliveries_list: {
        parameters: {
            query: {
                /** @description ID of the source object (Purchase, Payment, Payout, or BillingTemplateClient) to retrieve webhook deliveries for. */
                id: string;
